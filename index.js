...
function getPreviousPalindromeDate(date) {
  ...
  while (true) {
    ...
    var isPreviousDatePalindrome =
      checkPalindromeForAllDateFormats(previousDate);
  ...
  if (dateOfBirthValue !== "") {
    ...
    if (isPalindrome) {
      ...
      setTimeout(() => {
        ...
        outputText.innerHTML = `<span>🎉</span> <span>🎉</span> <span>🎉</span> Yayyyyy! Your birthday <span id="output-text-inverted">${dateOfBirthValue}</span> is a palindrome. <span>🎉</span>`;
      }, 1500);
    } else {
      ...
      setTimeout(() => {
        ...
        outputText.innerHTML = `
             Sorry! Your birthday <span id="output-text-inverted">${dateOfBirthValue}</span> is not a palindrome. <span>🙁</span> <br> 
    ...
    setTimeout(() => {
      outputText.style.display = "block";
      outputText.innerHTML =
        "<span>🙁</span> You need to enter your full and valid Date of Birth above! <span>🙁</span>";
    }, 1500);
  }
}
